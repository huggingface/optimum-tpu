...
# HACK: This is a workaround to permit keeping the code from the original file that was supporting SlidingWindowCache,
# while avoiding full support and having to import the feature from the upstream transformers (not yet in current
# release).
