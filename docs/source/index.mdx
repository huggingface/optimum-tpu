...
<div class="mt-10">
    <div class="w-full flex flex-col space-y-4 md:space-y-0 md:grid md:grid-cols-2 md:gap-y-4 md:gap-x-5">
        ...
        >
            <div class="w-full text-center bg-gradient-to-br from-blue-500 to-blue-800 rounded-lg py-1.5 font-semibold mb-5 text-white text-lg leading-relaxed">
                Tutorials
            </div>
            <p class="text-gray-700">
                Practical scenarios to demonstrate typical usages and APIs leveraging Google TPUs
            </p>
        </a>
